...
static int bee_phy_init_seq[] = {0x2C, 0x31, 0x20, 0x32, 0x1, 0x0D, 0x1, 0x10, -1};
#ifdef CONFIG_USB_ANDROID
static struct msm_hsusb_platform_data msm_hsusb_pdata = {
	.phy_init_seq		= bee_phy_init_seq,
	.usb_id_pin_gpio =  BEE_GPIO_USB_ID_PIN,
};
...
static void bee_add_usb_devices(void)
{
...
static struct htc_headset_gpio_platform_data htc_headset_gpio_data = {
	.hpin_gpio		= BEE_GPIO_35MM_HEADSET_DET,
	.key_enable_gpio	= BEE_GPIO_35MM_KEY_INT_SHUTDOWN,
	.mic_select_gpio	= 0,
};
...
static struct i2c_board_info i2c_sensor[] = {
	{
		I2C_BOARD_INFO(AKM8975_I2C_NAME, 0x0F),
...
static struct capella_cm3602_platform_data capella_cm3602_pdata = {
	...
	.irq = MSM_GPIO_TO_INT(BEE_GPIO_PROXIMITY_INT),
};
...
static struct msm_serial_hs_platform_data msm_uart_dm1_pdata = {
	.rx_wakeup_irq = MSM_GPIO_TO_INT(BEE_GPIO_BT_HOST_WAKE),
...
static void __init bee_init(void)
{
	 ...
	 * vreg.
	 */
	gpio_request(BEE_GPIO_LS_EN, "ls_en");
	gpio_request(BEE_PS_2V85_EN, "ps_pw_en");
