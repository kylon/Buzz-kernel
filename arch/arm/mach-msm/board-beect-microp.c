/* arch/arm/mach-msm/board-beect-microp.c
...
static struct i2c_client *beect_microp_client;

static int beect_microp_function_init(struct i2c_client *client)
{
...
static struct microp_ops ops = {
	.init_microp_func = beect_microp_function_init,
};
